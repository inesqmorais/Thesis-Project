...
<body onload="filterCols(); sortTable();" class= "students_page">
  ...
  <div class="title">
    <h1 style="font-family:Sans-serif;" class="heading">Students</h1>
	</div>
  ...
  <div class="sort">
    ...
    <table class="s_table" id="myTable">
    ...
    <thead>
      <tr>
        ...
        <td><b>Enroll Year</b></td>
        <td><b>End Year</b></td>
        <td><b>PT Program</b></td>
        <td><b>PT Institution</b></td>
        <td><b>CMU Program</b></td>
        <td><b>CMU Institution</b></td>
        <td><b>CMU Department</b></td>
      </tr>
    </thead>
    ...
    <tbody> 
      ...
      <tr onclick= "location.href='student_profile.php?varname=<?php echo $data['name'] ?>';">
        ...
        <td><?php echo $data['PT Program']; ?></td>
        <td><?php echo $data['PT school']; ?></td>  
        <td><?php echo $data['CMU Program']; ?></td>  
        <td><?php echo $data['CMU School']; ?></td>  
        <td><?php echo $data['CMU Department']; ?></td>    
      </tr>
