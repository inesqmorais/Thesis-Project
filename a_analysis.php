...
<body class= "students_page">
	...
	<p class='s_p_p'> Affiliated students grouped by enrollment year and current status </p>

	    <table class="s_p_table">

	        <?php

	          	$fetch_q1 = fetch_A_status_year();
	...
	<p class='s_p_p'> Affiliated students grouped by enrollment year and research area </p>

	    <table class="s_p_table">

	        <?php

	          	$fetch_q2 = fetch_A_area_year();
	...
	<p class='s_p_p'> Affiliated students grouped by enrollment year and CMU department </p>

	    <table class="s_p_table">

	        <?php

	          	$fetch_q3 = fetch_A_dept_year();
	...
	<p class='s_p_p'> Affiliated students grouped by institution PT </p>

	    <table class="s_p_table">

	        <?php

	          	$fetch_q4 = fetch_A_instPT();
	...
	<p class='s_p_p'> Affiliated students grouped by gender</p>

	    <table class="s_p_table">

	        <?php

	          	$fetch_q5 = fetch_A_gender();
	...
	<p class='s_p_p'> Affiliated students grouped by nationality </p>

	    <table class="s_p_table">

	        <?php

	          	$fetch_q6 = fetch_A_nationality();
