...
<body class= "students_page">
	...
	<div class= "s_form">
		<form class="student" action="update_student_rem_advisor.php" method="post">
			...
			<p class= "s_form_p" style="text-transform: none;"> Advisor to delete: <input type="text" name="newAdv" list="advs" required></p>
				<datalist id="advs">
				  <?php 
				  $options = fetch_Advs();
				  foreach ($options as $option) {
